...
Process:
Data Collection: Integrating official ASTRA accident datasets and Bern city traffic indices.
...
Data Manipulation: Pandas, Numint, Numpy
Statistical Analysis: SciPy (Linear Regression & Quantile-based Hotspot detection)
📂 Data Sources
ASTRA (Federal Roads Office): Official accident statistics with person injuries via data.geo.admin.ch.
Stadt Bern: Annual bicycle traffic indices and infrastructure project data.
📖 How to Use this Notebook
Open the file in Google Colab.
Run all cells sequentially.
Note: The notebook is designed to automatically attempt a download of the ASTRA dataset. If the official URL changes, please follow the manual download instructions provided in the "Data Collection" cell.
⚠️ Limitations
